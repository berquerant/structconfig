// Code generated by "goconfig -configOption Option -option -output structconfig_config_generated.go -field AnyCallback AnyCallbackFunc|AnyEqual AnyEqualFunc|Prefix string|Arguments []string"; DO NOT EDIT.
