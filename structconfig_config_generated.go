// Code generated by "goconfig -configOption Option -option -output structconfig_config_generated.go -field AnyCallback AnyCallbackFunc|AnyEqual AnyEqualFunc|Prefix string|EnvPrefix string|Arguments []string|Logger *slog.Logger"; DO NOT EDIT.
...
func (s *ConfigBuilder) EnvPrefix(v string) *ConfigBuilder {
	s.envPrefix = v
	return s
}
...
func (s *ConfigBuilder) Build() *Config {
	return &Config{
		...
		EnvPrefix:   NewConfigItem(s.envPrefix),
...
func WithEnvPrefix(v string) Option {
	return func(c *Config) {
		c.EnvPrefix.Set(v)
	}
}
